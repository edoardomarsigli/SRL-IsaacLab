...
if TYPE_CHECKING:
    ...
    from .commands_cfg import NormalVelocityCommandCfg, UniformVelocityCommandWheelCfg, UniformWorldVelocityCommandCfg
...
class UniformVelocityCommandWheel(CommandTerm):
    ...
    cfg: UniformVelocityCommandWheelCfg
    """The configuration of the command generator."""

    def __init__(self, cfg: UniformVelocityCommandWheelCfg, env: ManagerBasedEnv):
...
class NormalVelocityCommand(UniformVelocityCommandWheel):

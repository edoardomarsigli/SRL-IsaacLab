...
from .velocity_command import NormalVelocityCommand, UniformVelocityCommandWheel, UniformWorldVelocityCommand
...
@configclass
class UniformVelocityCommandWheelCfg(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = UniformVelocityCommandWheel
...
@configclass
class NormalVelocityCommandCfg(UniformVelocityCommandWheelCfg):

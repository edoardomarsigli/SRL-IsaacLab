...
gym.register(
    id="Moonshot-Velocity-Flat-Hero-Vehicle-Play-v0_edo",
    entry_point="isaaclab_tasks.manager_based.moonshot.locomotion_edo.velocity.HeroDragonEnv:HeroDragonEnv",
    disable_env_checker=True,
    kwargs={

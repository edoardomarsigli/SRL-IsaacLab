...
gym.register(
    id="Locomotion-HeroDragon-v0",
    entry_point="isaaclab_tasks.manager_based.moonshot.locomotion_edo_dragon.velocity.HeroDragonEnv:HeroDragonEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:HeroDragonEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:HeroDragonPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
    },
)

gym.register(
    id="Locomotion-HeroDragon-Play-v0",
    entry_point="isaaclab_tasks.manager_based.moonshot.locomotion_edo_dragon.velocity.HeroDragonEnv:HeroDragonEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:HeroDragonEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:HeroDragonPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
    },
)

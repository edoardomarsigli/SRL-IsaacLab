...
class HeroVehicleRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # rewards
        self.rewards.track_lin_vel_xy_exp.params["body_name"] = BASE_NAME
        self.rewards.track_ang_vel_z_exp.params["body_name"] = BASE_NAME
...
class HeroVehicleMoonEnvCfg_PLAY(HeroVehicleRoughEnvCfg):
    def __post_init__(self):
        ...
        # self.viewer.eye = (0.0, 0.0, 2.5) # for top down view 

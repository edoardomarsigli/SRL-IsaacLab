...
class RewardsCfg:
    ...
    # -- penalties
    termination_penalty = RewTerm(func=mdp.is_terminated, weight=-100)
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="leg1link.*"), "threshold": 0.0001},
    )

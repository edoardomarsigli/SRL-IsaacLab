...
@configclass
class HeroDragonGraspEnvCfgMadrl(DragonGraspEnvCfg):
...
@configclass
class HeroDragonGraspEnvCfg_PLAYMadrl(HeroDragonGraspEnvCfgMadrl):
    def __post_init__(self):
        super().__post_init__()

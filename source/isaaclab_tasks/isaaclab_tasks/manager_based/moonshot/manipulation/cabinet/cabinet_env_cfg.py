...
class DragonGraspSceneCfg(InteractiveSceneCfg):
    ...
    # (opzionale) frame per target della maniglia
    handle_frame = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                prim_path="{ENV_REGEX_NS}/hero_wheel/wheel11_in/wheel11_center/wheel11_out",  # deve esistere nel .usd
                name="handle_target_leg3",
                offset=OffsetCfg(
                    pos=(0.0, 0.0, 0.0),  # cambia se serve
                    rot=(0.0, 0.0, 0.0, 1.0),
                ),
            ),
        ],
...
class DragonGraspEnvCfg(ManagerBasedRLEnvCfg):
    scene: DragonGraspSceneCfg = DragonGraspSceneCfg(
        ...
        ee_frame=FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/hero_dragon/leg3gripper2_base/visuals/gripper_base",
            debug_vis=True,

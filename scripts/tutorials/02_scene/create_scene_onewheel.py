...
base_link_pos = {"leg3_joint1": 0.0}
leg3_link1_pos = {"leg3_joint2": 0.0}
leg3_link2_pos = {"leg3_joint3": 0.0}
leg3_link3_pos = {"leg3_joint4": 0.0}
leg3_link4_pos = {"leg3_joint5": 0.0}
leg3_link5_pos = {"leg3_joint6": 0.0}
leg3_link6_pos = {"leg3_steering_joint": 0.0}

all_joint_pos = leg3_wheel_body_pos | base_link_pos | leg3_link1_pos | leg3_link2_pos | leg3_link3_pos \
    | leg3_link4_pos | leg3_link5_pos | leg3_link6_pos
...
class OnewheelSceneCfg(InteractiveSceneCfg):
    ...
    # articulation
    onewheel: ArticulationCfg = HERO_ONEWHEEL_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
def main():
    ...
    # Design scene
    scene_cfg = OnewheelSceneCfg(num_envs=args_cli.num_envs, env_spacing=2.0)
